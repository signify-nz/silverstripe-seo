    ...
    public function responses()
    {
        return [
            static::FOCUS_KEYWORD_IRRELEVANT => [
                _t(
                    __CLASS__ . '.FOCUS_KEYWORD_IRRELEVANT',
            ...
            static::FOCUS_KEYWORD_NOT_IN_URL => [
                _t(
                    __CLASS__ . '.FOCUS_KEYWORD_NOT_IN_URL',
                    'The focus keyword is not in the url segment; consider changing this' .
                        ' and if you do SilverStripe will automatically redirect your old URL!'
                ),
                'warning'
            ],
            static::FOCUS_KEYWORD_SUCCESS => [
                _t(
                    ...
                    'The focus keyword is in the url segment; this is great!'
                ),
                'success'
            ],
        ];
